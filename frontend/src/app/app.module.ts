...
import { ZumbotronComponent } from './zumbotron/zumbotron.component';
...
@NgModule({
  declarations: [AppComponent, ExpertValidateDashboardComponent, DialogOverviewExampleDialog, ExpertLoginComponent, ExpertRegisterComponent, ExpertDashboardComponent, DashboardComponent, MovieDomainSearchComponent, MedicalDomainSearchComponent, SearchResultComponent, ExpertAnalyticsComponent, ExpertAnalyticsMovieComponent, ExpertAnalyticsMedicalComponent, ExpertAnalyticsGraphComponent, ExpertQueriesComponent, ExpertQueriesDialog, ZumbotronComponent, DomainsComponent, NavbarComponent, FooterComponent],
  imports: [BrowserModule, AppRoutingModule, MatProgressSpinnerModule, MatDialogModule, MatFormFieldModule, MatInputModule, MatIconModule, FormsModule, HttpClientModule, PapaParseModule, BrowserAnimationsModule, MatTableModule, MatButtonModule, MatCardModule, MatSelectModule, ReactiveFormsModule, MatListModule],
